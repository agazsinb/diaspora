...
if(!function_exists('magbook_get_option_defaults_values')):
	...
	function magbook_get_option_defaults_values() {
		...
		$magbook_default_values = array(
			...
			'magbook_category_slider' =>array(),
			'magbook_default_category_slider' => array(),
			'magbook_small_slider_post_category' => array(),
			...
			'magbook_featured_news_category' => array(),
			/* Frontpage Breaking News */
			'magbook_disable_breaking_news'	=> 1,
			'magbook_total_breaking_news'	=> '3',
			'magbook_breaking_news_title'	=> 'Breaking News',
			'magbook_breaking_news_category' => array(),
			/*Social Icons */
