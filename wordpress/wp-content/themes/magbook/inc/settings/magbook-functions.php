...
function magbook_breaking_news_display(){
	...
	$query = new WP_Query(array(
		...
		'category__in' => intval($magbook_settings['magbook_breaking_news_category']),
	));
...
function magbook_category_sliders() {
	...
	$query = new WP_Query(array(
				...
				'category__in' => intval($magbook_settings['magbook_default_category_slider']),
			));
	...
	$small_query = new WP_Query(array(
				...
				'category__in' => intval($magbook_settings['magbook_small_slider_post_category']),
			));
